        ...
        <div className="aa-most-viewed-box">
          ...
          {dashboardData.mostViewedProject ? (
            <>
              ...
              <div className="aa-view-meta aa-view-meta-fix">
  <div className="aa-view-meta-item aa-view-meta-item-fix">
    <img src={userIcon} className="aa-view-meta-icon aa-view-meta-icon-fix" />
    <span>{dashboardData.mostViewedProject.author}</span>
  </div>
  <div className="aa-view-meta-item aa-view-meta-item-fix">
    <img src={yearIcon} className="aa-view-meta-icon aa-view-meta-icon-fix" />

...
export default function NavigationBar({ studentName }) {
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.2 }}>
            ...
            <span style={{ fontSize: "8px", fontWeight: 400 }}>Capsort Archiving and Sorting System</span>
          </div>
        </div>

        <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
          <div style={{ borderBottom: "1px solid black", fontWeight: "700", cursor: "pointer" }} onClick={() => navigate("/guest")}>
            Projects
          </div>
          <div style={{ cursor: "pointer" }} onClick={() => navigate("/saved")}>Saved Projects</div>
          <div style={{ cursor: "pointer" }} onClick={() => navigate("/studentabout")}>About Us</div>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <img src={userImg} alt="User" style={{ width: "12px", height: "12px", borderRadius: "20%" }} />
            </div>
  ...
  <div style={{
    ...
    <div
      style={{ padding: "8px", cursor: "pointer", color: "black", display: "flex", alignItems: "center", gap: "8px" }}
      onClick={() => navigate("/login")}
    >
      <img src={require("../assets/signout.png")} alt="Sign Out" style={{ width: "12px", height: "12px" }} />
      <span>Sign Out</span>
    </div>
  </div>
)}
      ...
      {/* Title & Papers Found */}
      <div style={{ position: "absolute", top: "61px", right: "50px", fontFamily: "Poppins", fontSize: "16px", fontWeight: 600, color: "#1A1851" }}>
        Capstone Projects
      </div>
      <div style={{ position: "absolute", top: "82px", right: "50px", fontFamily: "Poppins", fontSize: "11px", fontWeight: 400, color: "#6A6A6A" }}>
        0 paper found
      </div>
          ...
          return (
            <div key={index} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "6px", fontWeight: 600, fontSize: "13px" }}>
                <img src={require("../assets/book.png")} alt="Book" style={{ width: "18px", height: "18px" }} />
                {title}
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "10px", color: "#6A6A6A" }}>
                <img src={require("../assets/author.png")} alt="Author" style={{ width: "12px", height: "12px" }} /> {author}
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "10px", color: "#6A6A6A" }}>
                <img src={require("../assets/year.png")} alt="Year" style={{ width: "12px", height: "12px" }} /> {year}
              </div>

              {/* View Button */}
              <div style={{ marginTop: "12px", display: "flex", justifyContent: "flex-end" }}>
                <button
                  style={{ backgroundColor: "white", color: "black", border: "0.5px solid black", borderRadius: "4px", padding: "4px 18px", fontSize: "9px", cursor: "pointer", transition: "all 0.2s ease" }}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button style={{
              ...
              fontSize: "16px",
              cursor: "pointer"
            }} onClick={() => setPopupData(null)}>×</button>

            <h2 style={{ fontSize: "14px", fontWeight: 600 }}>{popupData.title}</h2>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "6px", marginTop: "10px" }}>
              ...
              <img
                ...
                onMouseEnter={(e) => { if (!isSaved) e.currentTarget.src = require("../assets/saved.png"); }}
                onMouseLeave={(e) => { if (!isSaved) e.currentTarget.src = require("../assets/save.png"); }}
                onClick={() => { setIsSaved(true); setShowSavedPopup(true); }}
              />
            </div>
